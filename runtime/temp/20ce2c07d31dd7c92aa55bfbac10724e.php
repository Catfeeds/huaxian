<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"E:\WWW\huaxian\public/../application/index\view\gov\file.html";i:1527749637;s:66:"E:\WWW\huaxian\public/../application/index\view\common\header.html";i:1527737782;s:66:"E:\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527586945;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
<body> -->
  ...
  <div class="wrap">
    <div class="center fupinzc">
      <p class="top_title">您现在的位置 | <a href="<?php echo url('Gov/index'); ?>">政府风貌</a> > | <span> 政府文件 </span></p>  
      <h1>政府文件</h1>
      <div class="file_list">
        <div class="file_list_center">
          <?php if(is_array($file) || $file instanceof \think\Collection || $file instanceof \think\Paginator): $i = 0; $__LIST__ = $file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <div class="file_detail"><a href="<?php echo url('Gov/filedetail',array('id'=>$vo['id'])); ?>" style="color: #666;"><?php echo $vo['file']; ?></a></div>

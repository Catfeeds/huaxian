<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\city\jinhe-add.html";i:1526891081;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('City/jinheadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl" >
      <label class="form-label col-2"><span class="c-red">*</span>锦和新城图片：</label>
      <div class="formControls col-8"> 
          <span class="btn-upload form-group">
    ...
    <!-- <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>锦和新城内容：</label>
      <div class="formControls col-8"> 
    ...
    <!-- <div class="row cl">
      ...
      <div class="col-9 col-offset-3" style="margin-top:10px;">
        ...
        <a href="<?php echo url('City/lst_jinhe'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>

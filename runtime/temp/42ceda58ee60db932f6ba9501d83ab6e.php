<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\WWW\huaxian\public/../application/index\view\work\lst_ruodian.html";i:1527069864;s:66:"E:\WWW\huaxian\public/../application/index\view\common\header.html";i:1527665511;s:66:"E:\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527586945;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>弱电接入</title>
...
<body> -->
    ...
    <div class="wrap" style="padding:15px 0;"> 
        <div class="wgPower">
            <!-- 顶部面包屑导航 -->
            <div>
                <p class="top_title">您现在的位置 | <a href="<?php echo url('Work/index'); ?>">办事指南</a> > | <span> 弱电接入 </span></p>
            </div>              
            <div class="wgPower_content">
                 <h2>—— 弱电接入 ——</h2>
                 <h3>一、 申报材料</h3>
                 <?php echo $ruodian['content']; ?>
                 <h3>二、 地址</h3>  
                 <p><?php echo $ruodian['address']; ?></p>  
            </div> 
        </div>
    </div>
    <!-- 引用公共底部 -->

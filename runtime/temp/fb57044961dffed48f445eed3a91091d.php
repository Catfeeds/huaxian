<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\WWW\huaxian\public/../application/admin\view\work\lst_gongshui.html";i:1526518069;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb"> 
     供水接入管理 <span class="c-gray en">&gt;</span> 
     供水接入列表 
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('Work/gongshuiadd'); ?>" class="btn btn-danger radius" >
          <i class="Hui-iconfont">&#xe600;</i> 添加供水接入</a>
    </span> 
    <span class="l" style="margin-left: 20px;">
          <a href="<?php echo url('Work/gongshuiedit',array('id'=>$list['id'])); ?>" class="btn btn-danger radius" >
          <!-- <i class="Hui-iconfont">&#xe600;</i> --> 修改供水接入内容</a>
    </span>
    </div>
    <div class="mt-20">

...
<body> -->
  ...
  <div class="wrap">
    <div class="center">
      <p class="top_title">您现在的位置 | <a href="<?php echo url('Index/index'); ?>">首页</a> > | <span> 扶贫攻坚 </span></p>  
      <h1>扶贫动态
        <a href="<?php echo url('Index/helpdongtai'); ?>" class="right">更多>></a>
      </h1>
      <!--<script>
        var num = 1;
      ...
      <h1>扶贫政策
        <a href="<?php echo url('Index/helpzhengce'); ?>" class="right">更多>></a>
      </h1>
      <div class="file_list">
        <div class="file_list_center">

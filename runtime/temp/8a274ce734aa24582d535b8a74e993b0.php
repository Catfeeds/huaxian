<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\WWW\huaxian\public/../application/admin\view\work\ruodian-add.html";i:1526518639;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Work/ruodianadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>弱点接入申报材料：</label>
      <div class="formControls col-8"> 

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"D:\phpStudy\WWW\huaxian\public/../application/index\view\call\contactUs.html";i:1527229233;s:75:"D:\phpStudy\WWW\huaxian\public/../application/index\view\common\header.html";i:1527239238;s:75:"D:\phpStudy\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527214262;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>联系我们</title>
...
<body> -->
    ...
    <div class="wrap">
        ...
        <div class="top">
            ...
            <div class="top-nav">
                <ul>
                    <li tipName='产业聚集区官网'><a href="<?php echo url('Index/index'); ?>">首页</a></li>
    ...
    <div class="wrap" style="padding:15px 0;"> 
        ...
        <div class="contentUs">  
            ...
            <div class="usName">
                <h2>滑县产业集聚区</h2>
                <div class="line"></div>
                <p>滑县产业集聚区位邻县城区，规划面积15平方公里，起步区5.5平方公里，发展区5平方公里，控制区4.5平方公里，又称作滑县新区。目前，《滑县产业集聚区总体发展规划》、《滑县产业集聚区空间规划》、《滑县产业集聚区控制性详细规划》都已通过专家评审。</p>
            </div>
            <!--  联系我们 方式 -->
            <div class="usAbout">
                <ul>
            ...
            <!--  联系我们 地图 -->
            <div class="usMap">
                 <iframe align="center" width="1000" height="350" src="<?php echo url('Call/map'); ?>"  frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" ></iframe>
            </div>

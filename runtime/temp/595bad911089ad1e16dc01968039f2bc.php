<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"E:\WWW\huaxian\public/../application/index\view\company\index.html";i:1527746777;s:66:"E:\WWW\huaxian\public/../application/index\view\common\header.html";i:1527737782;s:66:"E:\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527586945;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<script>
    $(function () {
        $(".inner-box").height($(".inner-box .dd").height()+50);
        $("#compony1 li").on("click", function () {
            $(this).children("span").removeClass('black');
            $(this).addClass('current').siblings().removeClass('current').children("span").addClass('black');

            $(this).children(".dd").fadeIn();
            $(this).siblings().children(".dd").fadeOut();
            $(".inner-box").height($(this).children(".dd").height()+50);
        })
    })
</script>
<!-- 引用公共头部 -->
        ...
        <div class="inner-box">
            <div class="tabTwo">
                <ul class="clearfix" id="compony1">
                            ...
                            <?php if(is_array($company) || $company instanceof \think\Collection || $company instanceof \think\Paginator): $i = 0; $__LIST__ = $company;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <div class="wrap2">
                                    ...
                                    <div class="right">
                                        ...
                                        <!-- <p>河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美。</p> -->
                                    </div>
                                </div>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <!-- <div class="wrap2">
                                <div class="left">
                                    <img src="__PUBLIC__/images/company1.png" alt="">
                                </div>
                                <div class="right">
                                    <h2>华康粮油</h2>
                                    <p>河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美河南省华康最求完美。</p>
                    ...
                    <li>
                        <span class="black">重点项目</span>
                        <div class="dd" style="display: none;">
                            <?php if(is_array($project) || $project instanceof \think\Collection || $project instanceof \think\Paginator): $i = 0; $__LIST__ = $project;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;?>
                                <div class="wrap2">
                                    <div class="left">
                                        <img src="__IMG__<?php echo $v1['image']; ?>" alt="">
                                    </div>
                                    <div class="right">
...
<script type="text/javascript">
    $('.top-nav li:eq(3)').css('background-color','#6c9fee');
</script>
</html>
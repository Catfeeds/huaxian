<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\WWW\huaxian\public/../application/admin\view\company\project-add.html";i:1526975095;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Company/projectadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl" >
      <label class="form-label col-2"><span class="c-red">*</span>重点项目图片：</label>
      <div class="formControls col-8"> 
          <span class="btn-upload form-group">

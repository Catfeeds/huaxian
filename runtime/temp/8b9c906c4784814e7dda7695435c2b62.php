<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"E:\WWW\huaxian\public/../application/admin\view\work\gongshui-edit.html";i:1527823032;}*/ ?>
   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
    ...
    <form action="<?php echo url('Work/gongshuiedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">

...
<body> -->
    ...
    <div class="wrap" style="padding:15px 0;"> 
        <div class="wgPower">
            <!-- 顶部面包屑导航 -->
            <div>
                <p class="top_title">您现在的位置 | <a href="<?php echo url('City/index'); ?>">城市建设</a> > | <span> 远期规划详情 </span></p>
            </div>              
            <div class="content">

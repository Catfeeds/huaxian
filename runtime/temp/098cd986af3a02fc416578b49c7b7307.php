...
<body> -->
  ...
  <div class="wrap">
    <div class="center">
      <p class="top_title">您现在的位置 | <a href="<?php echo url('Gov/index'); ?>">政府风貌</a> > | <span> 文件详情 </span></p>
      <!-- <div class="download_button">
        <a href="<?php echo url('Gov/download',array('id'=>$file['id'])); ?>">

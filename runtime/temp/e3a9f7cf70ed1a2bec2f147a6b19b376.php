<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\gov\events-add.html";i:1526606771;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Gov/eventsadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl" >
      <label class="form-label col-2"><span class="c-red">*</span>大事记图片：</label>
      <div class="formControls col-8"> 
          <span class="btn-upload form-group">
    ...
    <div class="row cl">
        <label class="form-label col-2"><span class="c-red">*</span>大事记描述：</label>
        <div class="formControls col-8">
            <textarea name="description" class="textarea"  placeholder="请输入大事记描述的基本内容..." nullmsg="描述不能为空！" onKeyUp="textarealength(this,300)"></textarea>
        </div>
    </div>
    <!-- <div class="row cl">
      ...
      <div class="col-9 col-offset-3" style="margin-top:10px;">
        ...
        <a href="<?php echo url('Gov/lst_events'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\WWW\huaxian\public/../application/admin\view\gov\file-edit.html";i:1526899152;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Gov/fileedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl" style="margin-top: 40px;">
      ...
      <div class="formControls col-8">
        <span class="btn-upload form-group" style="padding-top: 3px;">
            <input class="input-text upload-url" type="text" name="file" id="uploadfile-2" style="width:500px" placeholder="请输入文件标题" value="<?php echo $list['file']; ?>">
            <!-- <a href="<?php echo url('Gov/download',array('id'=>$list['id'])); ?>" style="text-decoration: none;" title="点击下载文件"><?php echo $list['file']; ?></a> -->
        </span>
        <!-- <div style="margin-top: 10px;"> -->
            <!-- <span class="btn-upload form-group"> -->
                <!-- <a href="<?php echo url('Gov/fileedit1',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 点击重新上传文件</a> -->
    ...
    <!-- <div class="row cl" >
      ...
      <div class="col-9 col-offset-3" style="margin-top:30px;">
        ...
        <a href="<?php echo url('Gov/lst_file'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\admin\admin-add.html";i:1526610548;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form action="<?php echo url('Admin/add'); ?>" method="post" class="form form-horizontal" id="form-admin-add">
	    <div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" name="adminid" id="adminid" class="input-text" placeholder="请输入用户名"  

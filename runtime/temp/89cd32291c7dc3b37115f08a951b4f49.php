...
<div class="wrap">
  <div class="center">
    <p class="top_title">您现在的位置 | <a href="<?php echo url('Work/index'); ?>">办事指南</a> > | <span> 文件下载 </span></p>
      ...
      <div class="file_list">
        <div class="file_list_center">
          <div class="mid_content_download clearfix">
            <style>
              .mid_content_download ul li .download_button1 {
                float: right;
                width: 60px;
                color: #6391f1;
              }
              .mid_content_download ul li .download_button1:hover {
                color: blue;
              }
              .work_title {
            ...
            <ul>
              <?php if(is_array($file) || $file instanceof \think\Collection || $file instanceof \think\Paginator): $i = 0; $__LIST__ = $file;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <li>
                  <a href="" title="<?php echo $vo['file']; ?>"><span>【<?php echo $vo['address']; ?>】</span><span class="overhide"><?php echo $vo['file']; ?></span><span>[<?php echo $vo['time']; ?>]</span></a><a
                      href="<?php echo url('Work/download',array('id'=>$vo['id'])); ?>" class="download_button1">点击下载</a>
                </li>
              <?php endforeach; endif; else: echo "" ;endif; ?>
             <!--  <li><a href="#"><span>【金光路办事处】</span><span class="overhide">金光路党工委书记王文斌对柳湖办事处开展仓储物流消防安全检查工作园口村搅拌站环...</span><span>[2018-04-28 15:40]</span></a><a
                      href="#" class="download_button1">点击下载</a></li> -->
            </ul>
          </div>
        </div>
      </div>

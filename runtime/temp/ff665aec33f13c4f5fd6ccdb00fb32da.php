...
<body> -->
    ...
    <div class="wrap" style="padding:15px 0;"> 
        <div class="workGuide">  
            <!-- 顶部流程规范与相关链接 -->
            <div class="clearfix">
                <div class="top_content left">
                    <div class="work_title">
                        <h3>流程规范</h3>
                    </div>
                    <div class="work_content">
                        <ul>
                            <li><a href="<?php echo url('Work/lst_dianli'); ?>"><img src="__PUBLIC__/images/work_gd.png" alt="电力接入">电力接入</a></li>
                            <li><a href="<?php echo url('Work/lst_gongshui'); ?>"><img src="__PUBLIC__/images/work_gs.png" alt="供水接入">供水接入</a></li>
                            <li><a href="<?php echo url('Work/lst_ruodian'); ?>"><img src="__PUBLIC__/images/work_rd.png" alt="弱电接入">弱电接入</a></li>
                        </ul>
                    </div>
                </div>    
                <div class="top_content left">
                    ...
                    <div class="work_content_right">
                        <ul>
                            <li><a href="#"><img src="__PUBLIC__/images/work_fgbwa.png" alt="发改委备案"></a></li>
                            <li><a href="#"><img src="__PUBLIC__/images/work_hjyxpjba.png" alt="环境影响评价备案"></a></li> 
                        </ul>
                    </div>
                </div>     
            </div>
            ...
            <div class="mid_content">
                <div class="work_title" style="position: relative;">
                    <h3>文件下载</h3>
                    <a href="<?php echo url('Work/file'); ?>" style="position: absolute;top: 10px;right: 10px;font-size: 16px">
                        更多>>
                    </a>
                </div>
                <div class="mid_content_download clearfix">
                    <!--<style>
                        .mid_content_download a span
                    </style>-->
                    <ul>
            ...
            <div class="bottom_content">
                <div class="work_title_bottom">
                    <h3>企业入驻流程图</h3>
                </div>
                <div class="bottom_content_img">
                    <img src="__IMG__<?php echo $liucheng['image']; ?>" alt="企业入驻流程图">
                </div>
            </div>
        </div>  
    </div>

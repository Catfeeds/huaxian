<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\help\help-add1.html";i:1526954627;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<form action="" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-admin-add" name="example">
        ...
        <!-- <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" name="newstime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" id="datemin" class="input-text Wdate" placeholder="请选择新闻时间">
            </div>
        </div> -->
		<!--<div class="row cl">

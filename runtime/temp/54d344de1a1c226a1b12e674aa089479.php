...
<div class="wrap">
    <div class="center">
        <p class="top_title">您现在的位置 | <a href="<?php echo url('Message/index'); ?>" style="color: #666;">进言献策</a> > | <span> 热门问题 </span></p>
        <h1>热门问题</h1>
        <!--<script>
          var num = 1;

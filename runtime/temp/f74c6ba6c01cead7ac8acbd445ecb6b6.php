<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"E:\WWW\huaxian\public/../application/index\view\index\helpzhengce.html";i:1527754087;s:66:"E:\WWW\huaxian\public/../application/index\view\common\header.html";i:1527737782;s:66:"E:\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527586945;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body> -->
    ...
    <link rel="stylesheet" href="__PUBLIC__/css/poor.css">
<div class="wrap">
    <div class="center fupinzc">
        <p class="top_title">您现在的位置 | <a href="<?php echo url('Index/help'); ?>">扶贫攻坚</a> > | <span> 扶贫政策 </span></p>
        <h1>扶贫政策</h1>
        <!--<script>
          var num = 1;
        ...
        <div class="file_list">
            <div class="file_list_center">
                <?php if(is_array($help) || $help instanceof \think\Collection || $help instanceof \think\Paginator): $i = 0; $__LIST__ = $help;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <div class="file_detail"><a href="<?php echo url('Index/helpzhengcedetail',array('id'=>$vo['id'])); ?>" title="<?php echo $vo['title']; ?>" style="color: #666;"><?php echo $vo['title']; ?></a></div>

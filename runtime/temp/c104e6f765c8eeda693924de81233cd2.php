<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\WWW\huaxian\public/../application/admin\view\website\edit_link.html";i:1527640215;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	<form action="<?php echo url('Website/linkedit1'); ?>" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
		...
		<div class="row cl">
			<div class="col-9 col-offset-3">
				...
				<a href="<?php echo url('Website/linkedit',array('id'=>$id)); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
			</div>
		</div>
	</form>
</div>

	...
	<input type="hidden" name="id" value="<?php echo $notice['id']; ?>">
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" name="title" class="input-text" value="<?php echo $notice['title']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="标题不能为空" >
			</div>
			<div class="col-1"> </div>
		</div>
		<!--<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-8"> 
				<textarea name="content" id="content" style="width:100%; height: 700px;"><?php echo $notice['content']; ?></textarea> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit">提交</button>
				<a class="btn btn-primary radius" href="<?php echo url('News/lst_notice'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>

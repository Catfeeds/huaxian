<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\gov\events-edit.html";i:1526607082;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Gov/eventsedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <!-- <div class="row cl" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <?php if($list['image'] != ''): ?>
                    ...
                    <span class="btn-upload form-group">
                    <a href="<?php echo url('Gov/eventsedit1',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>
        ...
        <div class="formControls col-8">
            <textarea name="description" class="textarea"  placeholder="请输入大事记描述的基本内容..." nullmsg="描述不能为空！" onKeyUp="textarealength(this,300)"><?php echo $list['description']; ?></textarea>
        </div>
    </div>
        <!-- <div class="row cl">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\WWW\huaxian\public/../application/admin\view\city\lst_liutong.html";i:1527675480;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb"> 
     六通一平管理 <span class="c-gray en">&gt;</span> 
     六通一平列表 
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('City/liutongadd'); ?>" class="btn btn-danger radius" >
          <i class="Hui-iconfont">&#xe600;</i> 添加六通一平</a>
    </span> 
    <span class="l" style="margin-left: 20px;">
          <a href="<?php echo url('City/liutongedit',array('id'=>$list['id'])); ?>" class="btn btn-danger radius" >
          <!-- <i class="Hui-iconfont">&#xe600;</i> --> 修改六通一平内容</a>
    </span>
    </div>
    <div class="mt-20">
      <div class="row cl" style="margin-top: 40px; margin-left: 250px;" >
        ...
        <div class="formControls col-8">
            <textarea name="description" class="textarea"  placeholder="请输入六通一平描述内容..."  dragonfly="true" nullmsg="内容不能为空！" readonly="true" onKeyUp="textarealength(this,300)"><?php echo $list['description']; ?></textarea>
        </div>
      </div>
	    
	    <div class="row cl" style="margin-top: 20px;margin-left: 200px;">
	      	<label class="form-label col-2" style="width: 140px"><span class="c-red">*</span>六通一平内容：</label>
	      	<div class="formControls col-8"> 

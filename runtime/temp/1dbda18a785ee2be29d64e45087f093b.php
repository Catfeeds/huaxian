<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\WWW\huaxian\public/../application/admin\view\gov\file-add.html";i:1526898916;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Gov/fileadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <div class="row cl" style="margin-top: 40px;">
        <label class="form-label col-3"><span class="c-red">*</span>文件标题：</label>
        <div class="formControls col-5"> 
            <span class="btn-upload form-group">
                <input class="input-text upload-url" type="text" name="file" id="uploadfile-2" style="width:500px" placeholder="请输入文件标题">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\city\plan-edit.html";i:1527675252;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<title>修改远期规划信息</title>
</head>
<body>
<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" 
 href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
<div class="pd-20">
  <form action="<?php echo url('City/planedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
        <div class="row cl" style="margin-top: 40px; margin-left: 295px;" >
          ...
          <div class="formControls col-8">
              <textarea name="description" class="textarea"  placeholder="请输入远期规划描述相关内容..."  dragonfly="true" nullmsg="内容不能为空！" onKeyUp="textarealength(this,300)"><?php echo $list['description']; ?></textarea>
          </div>
        </div>
        <div class="row cl">
          <label class="form-label col-3"><span class="c-red">*</span>远期规划内容：</label>
          <div class="formControls col-8"> 
      ...
      <div class="col-9 col-offset-3" style="margin-top:30px;">
        ...
        <a href="<?php echo url('City/lst_plan'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>

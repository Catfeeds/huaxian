<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\WWW\huaxian\public/../application/admin\view\website\img-edit.html";i:1526609148;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Website/imgedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <input type="hidden" name="id" value="<?php echo $id; ?>">
    <div class="row cl" style="margin-top: 40px;">
      <label class="form-label col-3"><span class="c-red">*</span>图片标题：</label>
      <div class="formControls col-5">
        <input type="text" name="name" class="input-text" value="<?php echo $list['name']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="电话不能为空" style="width: 360px;">
      </div>
      <div class="col-1"> </div>
    </div>
    <!-- <div class="row cl" >
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <?php if($list['image'] != ''): ?>
                    ...
                    <span class="btn-upload form-group">
                    <a href="<?php echo url('Website/imgedit1',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>

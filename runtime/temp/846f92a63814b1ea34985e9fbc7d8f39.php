...
<body> -->
    ...
    <div class="wrap" style="padding:15px 0;"> 
        <div class="wgPower">
            <!-- 顶部面包屑导航 -->
            <div>
                <p class="top_title">您现在的位置 | <a href="<?php echo url('Work/index'); ?>">办事指南</a> > | <span> 供水接入 </span></p>
            </div>              
            <div class="wgPower_content">
                 <h2>—— 供水接入 ——</h2>
                 <h3>一、 申报材料</h3>
                 <?php echo $gongshui['content']; ?>
                 <h3>二、 地址</h3>  
                 <p><?php echo $gongshui['address']; ?></p>  
            </div> 
        </div>
    </div>
    <!-- 引用公共底部 -->

...
<head>
  ...
  <link rel="stylesheet" href="__PUBLIC__/css/inviteInvestment.css">
</head>
<body>
  <!-- 引用公共头部 -->
    <!-- <!DOCTYPE html>
...
<body> -->
  ...
  <div class="wrap">
    <div class="center">
      <p class="top_title">您现在的位置 | <a href="<?php echo url('Index/index'); ?>">首页</a> > | <span> 招商引资 </span></p>
      <div class="content">
        <?php echo $business['content']; ?>
      </div>
      <div class="poor_detail">
        ...
        <ul class="poor_list">
          <?php if(is_array($help) || $help instanceof \think\Collection || $help instanceof \think\Paginator): $i = 0; $__LIST__ = $help;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            <li><a href="<?php echo url('Index/helpzhengcedetail',array('id'=>$vo['id'])); ?>"><?php echo $vo['title']; ?></a><span>查看详情</span></li>

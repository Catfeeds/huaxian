<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\WWW\huaxian\public/../application/admin\view\file\add_file.html";i:1526896494;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('File/add_file'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <div class="row cl" style="margin-top: 40px;">
        <label class="form-label col-3"><span class="c-red">*</span>上传文件：</label>
    ...
    <!-- <div class="row cl">
      ...
      <div class="col-9 col-offset-3" style="margin-top:10px;">
        ...
        <!-- <a href="<?php echo url('File/lst_file'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a> -->
      </div>
    </div>
  </form>
</div>

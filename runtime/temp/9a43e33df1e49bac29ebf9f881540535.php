<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\WWW\huaxian\public/../application/admin\view\website\edit_call.html";i:1526020816;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<input type="hidden" name="id" value="<?php echo $list['id']; ?>">
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" name="call" class="input-text" value="<?php echo $list['call']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="电话不能为空" >
			</div>
			<div class="col-1"> </div>
		</div>
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" name="email" class="input-text" value="<?php echo $list['email']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="邮箱不能为空" >
            </div>
            <div class="col-1"> </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" name="address" class="input-text" value="<?php echo $list['address']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="地址不能为空" >
            </div>
            <div class="col-1"> </div>
        </div>
		<!--<div class="row cl">
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				...
				<a class="btn btn-primary radius" href="<?php echo url('Website/lst_call'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>

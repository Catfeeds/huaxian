<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\city\yuanqu-add.html";i:1527675341;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('City/yuanquadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    <div class="row cl" style="margin-top: 40px;">
      <label class="form-label col-3"><span class="c-red">*</span>描述：</label>
      <div class="formControls col-8">
          <textarea name="description" class="textarea"  placeholder="请输入园区规划的相关描述内容..." nullmsg="描述内容不能为空！" onKeyUp="textarealength(this,300)"></textarea>
      </div>
    </div>
    <div class="row cl">

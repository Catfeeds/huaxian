<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"E:\WWW\huaxian\public/../application/index\view\city\basic.html";i:1526888341;s:66:"E:\WWW\huaxian\public/../application/index\view\common\header.html";i:1527665511;s:66:"E:\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527586945;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>基础设施</title>
...
<body> -->
    ...
    <div class="wrap" style="padding:15px 0;"> 
        <div class="wgPower">
            <!-- 顶部面包屑导航 -->
            <div>
                <p class="top_title">您现在的位置 | <a href="<?php echo url('City/index'); ?>">城市建设</a> > | <span> 基础设施 </span></p>
            </div>              
             <div class="city_content_bf">
                <h3>卫生</h3>
                <p><?php echo $basic['health']; ?></p>
             </div>
             <div class="city_content_bf">
                <h3>文化</h3>
                <p><?php echo $basic['culture']; ?></p>
                
             </div>
             <div class="city_content_bf">
                <h3>教育</h3>
                <p><?php echo $basic['edu']; ?></p>
             </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\work\lst_dianli.html";i:1526467084;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('Work/dianliadd'); ?>" class="btn btn-danger radius" >
          <i class="Hui-iconfont">&#xe600;</i> 添加电力接入</a>
    </span> 
    <span class="l" style="margin-left: 20px;">
          <a href="<?php echo url('Work/dianliedit',array('id'=>$list['id'])); ?>" class="btn btn-danger radius" >
          <!-- <i class="Hui-iconfont">&#xe600;</i> --> 修改电力接入内容</a>
    </span>
    </div>
    <div class="mt-20">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\help\help-edit.html";i:1526954434;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	...
	<input type="hidden" name="id" value="<?php echo $help['id']; ?>">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>扶贫政策标题：</label>
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>扶贫政策内容：</label>
			<div class="formControls col-8"> 
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
				...
				<a class="btn btn-primary radius" href="<?php echo url('Help/lst_zhengce'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>

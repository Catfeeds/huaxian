<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:90:"C:\Users\ycPIGFF\Desktop\PHP\WWW\huaxian\public/../application/admin\view\login\login.html";i:1527561351;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<![endif]-->
<title>产业聚集区官网后台登录 </title>
</head>
<body>
<input type="hidden" id="TenantId" name="TenantId" value="" />
<div class="header" style="font-size: 22px; letter-spacing: 1px; line-height: 55px; color:#EEEEEE;">产业聚集区官网后台管理系统</div>
        ...
        <form class="form form-horizontal" action="<?php echo url('Login/login'); ?>" method="post"  id="form-admin-add">
            <div class="row cl">
                ...
                <div class="formControls col-8">
                    <input id="" name="adminid" type="text" placeholder="用户名" class="input-text size-L" datatype="*1-50" nullmsg="用户名不能为空">
                </div>

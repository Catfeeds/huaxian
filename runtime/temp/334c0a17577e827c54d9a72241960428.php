<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\work\dianli-add.html";i:1526518120;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Work/dianliadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl">
      <label class="form-label col-2"><span class="c-red">*</span>电力接入申报材料：</label>
      <div class="formControls col-8"> 
    ...
    <!-- <div class="row cl">
      ...
      <div class="col-9 col-offset-3" style="margin-top:10px;">
        ...
        <a href="<?php echo url('Work/lst_dianli'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>

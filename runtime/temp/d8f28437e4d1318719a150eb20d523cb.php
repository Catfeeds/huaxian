<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"E:\WWW\huaxian\public/../application/admin\view\file\my_file.html";i:1526897829;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
		    ...
		    <tbody>
		       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "<p class='nulltext'>暂无相关信息</p>" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			    <tr class="text-c">
				    ...
				    <td><?php echo $v['id']; ?></td>
				    <td><a href="<?php echo url('File/download',array('id'=>$v['id'])); ?>" style="text-decoration: none;" title="点击下载文件"><?php echo $v['file']; ?></a></td>

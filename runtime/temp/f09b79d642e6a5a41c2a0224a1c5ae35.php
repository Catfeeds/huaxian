<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\user\user-list.html";i:1526612551;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20 nullwrap">
	...
	<form action="<?php echo url('User/lst'); ?>" method="get">
        用户名：<input type="text" class="input-text" style="width:150px" placeholder="请输入账号" id="" name="keywords"
        value="">
	...
	<span class="l">
        <a class="btn btn-danger radius" href="<?php echo url('User/userexport',array('keywords'=>session('userkeywords'),'keyid'=>session('userkeyid'))); ?>" style="margin-right: 5px;">

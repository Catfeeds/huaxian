...
<div class="wrap">
    <div class="center">
        <p class="top_title">您现在的位置 | <a href="<?php echo url('Index/help'); ?>">扶贫攻坚</a> > | <span> 扶贫动态 </span></p>
        <h1>扶贫动态</h1>
        <!--<script>
          var num = 1;

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\news\news-edit.html";i:1526538850;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
	...
	<input type="hidden" name="id" value="<?php echo $news['id']; ?>">
		<div class="row cl">
			...
			<div class="formControls col-8">
				<input type="text" name="title" class="input-text" value="<?php echo $news['title']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="标题不能为空" >
			</div>
			<div class="col-1"> </div>
		</div>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>新闻时间：</label>
            <div class="formControls col-4">
                <input type="text" name="newstime" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" id="datemin" class="input-text Wdate" placeholder="请选择新闻时间" value="<?php echo $news['newstime']; ?>">
            </div>
        </div> 
		<!--<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-8"> 
				<textarea name="content" id="content" style="width:100%; height: 700px;"><?php echo $news['content']; ?></textarea> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit">提交</button>
				<a class="btn btn-primary radius" href="<?php echo url('News/lst_news'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>

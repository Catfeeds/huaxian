<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\city\lst_yuanqu.html";i:1527675362;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb"> 
     园区规划管理 <span class="c-gray en">&gt;</span> 
     园区规划列表 
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('City/yuanquadd'); ?>" class="btn btn-danger radius" >
          <i class="Hui-iconfont">&#xe600;</i> 添加园区规划</a>
    </span> 
    <span class="l" style="margin-left: 20px;">
          <a href="<?php echo url('City/yuanquedit',array('id'=>$list['id'])); ?>" class="btn btn-danger radius" >
          <!-- <i class="Hui-iconfont">&#xe600;</i> --> 修改园区规划内容</a>
    </span>
    </div>
    <div class="mt-20">
        ...
        <div class="formControls col-8">
            <textarea name="description" class="textarea"  placeholder="请输入园区规划描述内容..."  dragonfly="true" nullmsg="内容不能为空！" readonly="true" onKeyUp="textarealength(this,300)"><?php echo $list['description']; ?></textarea>
        </div>
      </div>
	    <div class="row cl" style="margin-top: 20px;margin-left: 200px;">
	      	<label class="form-label col-2" style="width: 140px"><span class="c-red">*</span>园区规划内容：</label>
	      	<div class="formControls col-8"> 

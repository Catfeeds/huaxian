<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:67:"E:\WWW\huaxian\public/../application/admin\view\gov\detail-add.html";i:1526607224;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Gov/detailadd'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
    ...
    <div class="row cl" >
      <label class="form-label col-3"><span class="c-red">*</span>园区图片：</label>
    ...
    <div class="row cl">
      <label class="form-label col-3"><span class="c-red">*</span>园区内容：</label>
      <div class="formControls col-8"> 
      ...
      <div class="col-9 col-offset-3" style="margin-top:10px;">
        ...
        <a href="<?php echo url('Gov/lst_detail'); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
      </div>
    </div>
  </form>
</div>

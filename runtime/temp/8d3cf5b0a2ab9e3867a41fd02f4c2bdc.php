<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\WWW\huaxian\public/../application/admin\view\company\lst_company.html";i:1526434762;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb"> 
     企业之窗管理 <span class="c-gray en">&gt;</span> 
     企业之窗列表 
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('Company/companyadd'); ?>" class="btn btn-danger radius" >
          <i class="Hui-iconfont">&#xe600;</i> 添加企业之窗</a>
    </span> 
		       ...
		       <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			    <tr class="text-c">
				    ...
				    <td class="td-manage">
                        ...
                        <a title="删除" href="<?php echo url('Company/companydel',array('id'=>$v['id'])); ?>"  onclick="return confirm('确定要删除吗？')" class="ml-5" style="text-decoration:none">
                        <i class="Hui-iconfont">&#xe6e2;</i></a>
				    </td>
			    </tr>

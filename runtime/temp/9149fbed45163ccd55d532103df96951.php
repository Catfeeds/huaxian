<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\WWW\huaxian\public/../application/index\view\city\waterdetail.html";i:1526888127;s:66:"E:\WWW\huaxian\public/../application/index\view\common\header.html";i:1527587046;s:66:"E:\WWW\huaxian\public/../application/index\view\common\footer.html";i:1527586945;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <title>污水处理厂详情</title>
...
<body> -->
    ...
    <div class="wrap" style="padding:15px 0;"> 
        <div class="wgPower">
            <!-- 顶部面包屑导航 -->
            <div>
                <p class="top_title">您现在的位置 | <a href="<?php echo url('City/index'); ?>">城市建设</a> > | <span> 污水处理厂详情 </span></p>
            </div>              
            <div class="content">
                <?php echo $water['content']; ?>
            </div>
        </div>
    </div>
     <!-- 引用公共底部 -->

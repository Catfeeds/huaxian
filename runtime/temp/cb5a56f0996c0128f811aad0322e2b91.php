<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"E:\WWW\huaxian\public/../application/admin\view\gov\lst_business.html";i:1526366545;}*/ ?>
﻿   <!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<nav class="breadcrumb"> 
     招商引资管理 <span class="c-gray en">&gt;</span> 
     招商引资列表 
...
<div class="pd-20">
    ...
    <span class="l">
          <a href="<?php echo url('Gov/businessadd'); ?>" class="btn btn-danger radius" >
          <i class="Hui-iconfont">&#xe600;</i> 添加招商引资</a>
    </span> 
    <span class="l" style="margin-left: 20px;">
          <a href="<?php echo url('Gov/businessedit',array('id'=>$list['id'])); ?>" class="btn btn-danger radius" >
          <!-- <i class="Hui-iconfont">&#xe600;</i> --> 修改招商引资内容</a>
    </span>
    </div>
    <div class="mt-20">
	    
	    <div class="row cl" style="margin-left: 200px;">
	      	<label class="form-label col-2" style="width: 120px"><span class="c-red">*</span>招商引资内容：</label>
	      	<div class="formControls col-8"> 
	        	<textarea name="content" id="content" style="width:100%; height: 700px;" readonly="readonly"  ><?php echo $list['content']; ?></textarea> 
	      	</div>
	    </div>
    </div>
</div>

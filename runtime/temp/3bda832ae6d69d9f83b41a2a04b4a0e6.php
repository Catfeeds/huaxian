<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\WWW\huaxian\public/../application/admin\view\company\company-edit.html";i:1526975057;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
  <form action="<?php echo url('Company/companyedit'); ?>" method="post" class="form form-horizontal" enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-8">
                <?php if($list['image'] != ''): ?>
                    ...
                    <span class="btn-upload form-group">
                    <a href="<?php echo url('Company/companyedit1',array('id'=>$list['id'])); ?>" class="btn btn-primary radius upload-btn"><i class="Hui-iconfont">&#xe642;</i> 编辑图片</a>

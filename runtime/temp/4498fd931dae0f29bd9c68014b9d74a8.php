<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\WWW\huaxian\public/../application/admin\view\company\edit_project.html";i:1526438706;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<![endif]-->
<title>重点项目图片修改</title>
</head>
<body>
    <a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:1px" 
    href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a>
<div class="pd-20">
	<form action="<?php echo url('Company/projectedit1'); ?>" method="post" class="form form-horizontal" id="form-admin-add" enctype="multipart/form-data">
		...
		<div class="row cl">
			<div class="col-9 col-offset-3">
				...
				<a href="<?php echo url('Company/projectedit',array('id'=>$id)); ?>" class="btn btn-primary radius">&nbsp;&nbsp;返回&nbsp;&nbsp;</a>
			</div>
		</div>
	</form>
</div>

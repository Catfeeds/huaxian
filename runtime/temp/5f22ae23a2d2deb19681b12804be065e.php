<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\WWW\huaxian\public/../application/admin\view\help\help-edit1.html";i:1526954995;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20">
	...
	<input type="hidden" name="id" value="<?php echo $help['id']; ?>">
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>扶贫动态标题：</label>
			<div class="formControls col-8">
				<input type="text" name="title" class="input-text" value="<?php echo $help['title']; ?>" placeholder="" id="" datatype="*1-200" nullmsg="标题不能为空" >
			</div>
			<div class="col-1"> </div>
		</div>
		<!--<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>扶贫动态内容：</label>
			<div class="formControls col-8"> 
				<textarea name="content" id="content" style="width:100%; height: 700px;"><?php echo $help['content']; ?></textarea> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-10 col-offset-2">
				<button onClick="article_save_submit();" class="btn btn-primary radius" type="submit">提交</button>
				<a class="btn btn-primary radius" href="<?php echo url('Help/lst_dongtai'); ?>">返回</a>
			</div>
		</div>
	</form>
</div>

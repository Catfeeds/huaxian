...
CREATE TABLE IF NOT EXISTS `tr_message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='进言献策表' AUTO_INCREMENT=16 ;
...
(55, '123', '202cb962ac59075b964b07152d234b70', '2018-05-25 10:11:21'),

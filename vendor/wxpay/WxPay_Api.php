...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(WxPayConfig::APPID);//公众账号ID  此处修改如下：
		$inputObj->SetMch_id(WxPayConfig::MCHID);//商户号
		// $inputObj->SetAppid('WxPayConfig','wxff62b195cb37ee5a');//公众账号ID
		// $inputObj->SetMch_id('WxPayConfig','1264087101');//商户号
		...
		$response = self::postXmlCurl($xml, $url, false, $timeOut);   //此处修改
	 ...
	 * @return 成功时返回，其他抛异常
	 */
	public static function orderQuery($inputObj, $timeOut = 60)    //此处修改，6改为60
	{
	...
	{		
		...
		//如果有配置代理这里就设置代理
		if(WxPayConfig::CURL_PROXY_HOST != "127.0.0.1" 

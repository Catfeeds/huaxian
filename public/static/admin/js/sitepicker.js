...
$(".ku1").on("click",function(e){
    if($(".xiala1").css("display")==="none"){
        var ss="";
        var si="";
        var qq="";
        if($(".xiala1").css("display")==="none"){
            $(".xiala1").css("display","block");
            $(".xiala1").html("<h1><span>确认</span></h1>");
            for(var i=0; i<dsy.Items[0].length; i++){
                $(".xiala1").append("<div class='0_"+i+"'><span>"+dsy.Items[0][i]+"</span><p></p></div>");
            }
        }
        $(".xiala1").on("click",function(e){
        e.stopPropagation();
            $(".xiala1").css("display","none");
            $(".xiala1>div>p").css("display","none");
            $(".xiala1>div>p>div>p").css("display","none");
        });
        var x=0;
        $(".xiala1>div").on("click",function(event){
            event.stopPropagation();
            if(($(this).children("p").css("display"))=="none"){
                $(".xiala1>div>p").css("display","none");
                $(".xiala1>div>p").html("");
        ...
        $(".xiala1>div>p>div").on("click",function(ee){
            ee.stopPropagation();
        if(($(this).children("p").css("display"))=="none"){
            si=$(this).children("span").html();
            $(".ku1>input").val(ss+si);
            ...
            if(y=="0_33_0"||y=="0_33_1"||y=="0_33_2"||y=="0_33_3"||y=="0_33_4"||y=="0_33_5"||y=="0_33_6"||y=="0_33_7"||y=="0_33_8"||y=="0_33_9"||y=="0_33_10"||y=="0_33_11"||y=="0_33_12"||y=="0_33_13"||y=="0_33_14"||y=="0_33_15"||y=="0_33_16"||y=="0_33_17"||y=="0_33_18"){
                ...
                $(".xiala1>div>p>div>p>span").on("click",function(eee){
                    eee.stopPropagation();
                    qq=$(this).html();
                    var xhr=ss+si+qq;
                    $(".ku1>input").val(xhr);
            ...
            $(this).children("p").css("display","none");
            $(".xiala1>div>p>div").children("p").html("");
            }
            })
            }else{
            $(this).children("p").css("display","none");
            $(".xiala1>div").children("p").html("");
            }
            });
            }else{
            $(".xiala1").css("display","none");
